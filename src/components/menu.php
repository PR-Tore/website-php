    ...
    <ul id="menu">
        <li>Industrie, Gewerbe, öffentliche Hand
            <ul>
                ...
                <li><a href="mobile_fahrzeugsperren" title="Mobile Fahrzeugsperre">Mobile Fahrzeugsperre</a></li>
                <li><a href="zufahrtskontrollsysteme" title="Zufahrtskontrollsysteme">Zufahrtskontrollsysteme</a></li>
