...
<footer>
    <div class="section-inner">
        ...
        <div class="lastcolumn floatright">
          <ul>
            <li><img class="footer_logo" src="./assets/img/pr-tore-logo.svg" alt="PR-Tore & Türen GmbH " width="180"/></li>
          </ul>
        </div>
    </div>
...
<div class="phonecall">
    <a href="kontakt#formular" title="E Mail verschicken"><img class="mailicon" src="./assets/img/mail.svg" width="80" alt="Mailbutton"></a>
    <a href="tel:052412330900" title="PR anrufen"><img class="phoneicon" src="./assets/img/phonecall.svg" width="80" alt="Anruf Button"></a>
</div>
