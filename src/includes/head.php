...
<head>
    ...
    <title><?php
        if (isset($pageTitle)) {
            ...
            echo Config::$default_meta['Title'];
        } ?></title>
    ...
    <meta name="keywords" content="<?php if (isset($pageKeyword)) {
        echo $pageKeyword;
    } else {
        echo Config::$default_meta['Keyword'];
    } ?>">
    <meta name="description" content="<?php if (isset($pageDescription)) {
        echo $pageDescription;
    } else {
        echo Config::$default_meta['Description'];
    } ?>">
    <meta name="robots" content="<?php if (isset($robots)) {
        echo $robots;
    } else {
        echo Config::$default_meta['Robots'];
    } ?>">
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PXQX7RX"
