    ...
    <div class="section-inner">
        ...
        <nav class="centercolumn floatleft">
          <ul class="kontaktdaten">
            <li><span><strong>Tel.: </strong></span><a href="tel:052412330900" title="Telefonnummer"> 05241 / 233 090 0</a></li>
            <li><span><strong>E-Mail:</strong></span> <a href="mailto:info@pr-tore.de" title="E-Mail Adresse"> info@pr-tore.de</a></li>
          </ul>
            <ul>
        ...
        <div class="lastcolumn floatright">
          <ul>
            <li><img class="footer_logo" src="img/pr-tore-logo.svg" alt="PR-Tore & Türen GmbH " width="180"/></li>
          </ul>
        </div>
    </div>
...
<div class="phonecall">
    <a href="kontakt#formular" title="E Mail verschicken"><img class="mailicon" src="img/mail.svg" width="80" alt="Mailbutton"></a>
    <a href="tel:052412330900" title="PR anrufen"><img class="phoneicon" src="img/phonecall.svg" width="80" alt="Anruf Button"></a>
</div>

<div class="handwritten">
  <div class="section-inner">
      <!-- <img style=""src="./img/handwritten_slogan.svg" alt="" width="220"> -->
