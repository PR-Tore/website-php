<?php include('./config.php');
      ...
      $canonical        =    $meta_service ["Canonical"];
?>
<!--Header & Head Infos-->
...
<section class="titlearea">
  <article>
    ...
    <div id="beratung" class="overflow">
        <h2>Beratung</h2>
    ...
    <div id="tore-tueren" class="overflow">
        ...
        <a href="gewerbe-tueren" title="Gewerbetür Informationen" class="orangebutton">Gewerbe-/ Industrietüren</a> <br><br>
